...
# Read valid subject IDs from Excel
...
# Define source folders and corresponding extras subfolders
folder_info <- list(
...
# Function to move unmatched files to appropriate subfolder
...
cat("âœ… Done! Unmatched files sorted into extras subfolders.\n")
