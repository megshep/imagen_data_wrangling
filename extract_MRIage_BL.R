...
# --- Load subject IDs (assumes ID is in the first column)
...
# --- Load age data (assumes ID is in first column, age in column named "ADNI MPRAGE")
...
cat("âœ… Excel file 'imagen_demographics.xlsx' created at:", output_path, "\n")
